...
KEYWORDS = ['VAR', 'AND', 'OR', 'NOT', 'IF', 'THEN', 'ELIF', 'ELSE', 'FOR', 'TO', 'STEP', 'WHILE', 'FUN', 'END', 'RETURN', 'CONTINUE', 'BREAK']
...
class Parser:
    ...
    def call(self):
        ...
        if self.current_tok.type == TT_LPAREN:
            ...
            if self.current_tok.type == TT_RPAREN:
                ...
                if res.error:
                    return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected ')', 'VAR', INT, FLOAT, IDENTIFIER, 'IF', 'FOR', 'WHILE', 'FUN', '+', '-', '(', '[', or 'NOT'"))
    ...
    def list_expr(self):
        ...
        if self.current_tok.type == TT_RSQUARE:
            ...
            if res.error:
                return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected ']', 'VAR', 'IF', 'FOR', 'WHILE', 'FUN', INT, FLOAT, IDENTIFIER, '+', '-', '(', '[' or 'NOT'"))
            while self.current_tok.type == TT_COMMA:
                res.register_advancement()
                self.advance()
    ...
    def statement(self):
        ...
        expr = res.register(self.expr())
        if res.error:
            return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, f"Expected 'RETURN', 'CONTINUE', 'BREAK', 'VAR', 'IF', 'FOR', 'WHILE', 'FUN', INT, FLOAT, IDENTIFIER, '+', '-', '(', '[', or 'NOT'"))
        return res.success(expr)
